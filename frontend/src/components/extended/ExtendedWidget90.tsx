...
interface ExtendedWidgetProps 90 {
  title: string;
  data: any[];
  onAction?: () => void;
}

export const ExtendedWidget90: React.FC<ExtendedWidgetProps90> = ({ title, data, onAction }) => {
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg border border-slate-200 m-4">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold text-slate-800">{title} - Component 90</h3>
