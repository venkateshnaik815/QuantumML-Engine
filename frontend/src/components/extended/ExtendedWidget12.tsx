...
interface ExtendedWidgetProps 12 {
  title: string;
  data: any[];
  onAction?: () => void;
}

export const ExtendedWidget12: React.FC<ExtendedWidgetProps12> = ({ title, data, onAction }) => {
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg border border-slate-200 m-4">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold text-slate-800">{title} - Component 12</h3>
